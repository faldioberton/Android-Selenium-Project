...
public class pageForm {
    By text_input = By.xpath("//android.widget.EditText[@content-desc='text-input']");
    By text_inputResult = By.xpath("//android.widget.TextView[@content-desc='input-text-result']");
    By btn_switch = By.xpath("//android.widget.Switch[@content-desc='switch']");

    By btn_dropdown = By.xpath("//android.view.ViewGroup[@content-desc='Dropdown']/android.view.ViewGroup");
